...
import { sendAuthCookie, queryAuthCookie, updateAuthCookie } from '@/api';
...
const updateCookieLoading = ref(false);
const showRight = ref(false);
const updateCookie = async () => {
    updateCookieLoading.value = true;
    await updateAuthCookie();
    updateCookieLoading.value = false;
};
